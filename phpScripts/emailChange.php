...
function emailChangePass($name, $href, $userid, $email) {
require_once 'configBD.php';

$url = "https://worldteaming.ru/password.php?id=". $userid ."&string=". $href;
        ...
        <td class="container">
            <table>
                ...
                <tr>
                    <td class="content">
                        <h2>Привет,'. ' ' . $name .'</h2>
                        <p>Для смены пароля нажмите на кнопку</p>
                        <table>
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href="'. $url .'" class="button" style="color: white;">Сменить!</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
